...
rel_abb_genus <- read.table('~/complete_pipeline/data/Relative_abundances_genus.csv', sep = '\t')
rel_abb_genus <- as.data.frame(t(rel_abb_genus))
rel_abb_genus$Code <- rownames(rel_abb_genus)

rel_abb_species <- read.table('~/complete_pipeline/data/Relative_abundances_species.csv', sep = '\t')
...
df_feno <- read.csv('~/complete_pipeline/data/clean_phenotypes.csv')
...
significant_result_independence <- read.csv('~/complete_pipeline/results/independence_test/significant_variable_independence_test.csv')[,-c(1,4)]
