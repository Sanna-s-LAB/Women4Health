...
if (!dir.exists(paste0("../Final_lagged/Linear_simulation_with_", a))) {
  dir.create(paste0("../Final_lagged/Linear_simulation_with_", a))
}
setwd(paste0("../Final_lagged/Linear_simulation_with_", a))
