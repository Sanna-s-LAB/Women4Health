...
if (!dir.exists(paste0("../Final_lagged/linear_on_non_linear/",rel_nonlinear))){
  dir.create(paste0("../Final_lagged/linear_on_non_linear/",rel_nonlinear))
}
setwd(paste0("../Final_lagged/linear_on_non_linear/",rel_nonlinear))
